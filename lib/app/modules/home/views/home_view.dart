                            ...
                            children: <Widget>[
                              if (state.hasDocument && state.sidebarVisible)
                                ReaderSidebar(
                                  ...
                                  onOpenOutlinePage: controller.jumpToOutlinePage,
                                ),
                              Expanded(
                                child: ColoredBox(
                              ...
                              if (state.aiSidebarVisible)
                                AiSidebar(
                                  ...
                                  onApiKeyChanged: controller.updateAiApiKey,
                                  onSiliconFlowApiKeyChanged: controller.updateSiliconFlowApiKey,
                                  onSaveApiKey: controller.saveAiApiKey,
                                  onSaveSiliconFlowApiKey: controller.saveSiliconFlowApiKey,
                                  onProviderChanged: controller.updateSelectedProvider,

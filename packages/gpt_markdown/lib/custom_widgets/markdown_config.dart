...
class GptMarkdownConfig {
  ...
  Text getRich(BuildContext context, InlineSpan span) {
    ...
    final uniqueFallbackFonts = <String>[];
    for (final family in fallbackFonts) {
      if (!uniqueFallbackFonts.contains(family)) {
        uniqueFallbackFonts.add(family);
      }
    }
    final textStyle = baseStyle.copyWith(
      fontFamilyFallback: uniqueFallbackFonts,
    );
    return Text.rich(
      span,
      style: textStyle,
